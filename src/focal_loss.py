...
class CustomDetectionLoss(v8DetectionLoss):
    ...
    Inherits from the original v8DetectionLoss and replace BCE with Focal Loss.
    """
    ...
    def __call__(self, preds: Any, batch: dict[str, torch.Tensor]) -> tuple[torch.Tensor, torch.Tensor]:
        """Calculate the sum of the loss for box, cls and dfl multiplied by batch size. Focal Loss for cls component."""
